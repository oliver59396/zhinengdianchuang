...
# ===================== 初始化 =====================
print("✅ FRDM-MCXN947 系统启动（匹配官方引脚图）")
#servo_angle(90)  # 舵机归中
time.sleep(1)
print("✅ 舵机初始化完成")
print("✅ MQ传感器预热中（需2分钟）...\n")
...
while True:
    ...
    # 4. 串口打印输出（电脑必看得到）
    print("="*35)
    print(f"📌 温度: {temp:>5.1f} ℃ | 湿度: {humi:>5.1f} %")
    print(f"📌 测距: {dist:>5.1f} cm")
    print(f"📌 MQ135: {mq135_v:>4.2f}V (报警: {mq135_alarm})")
    print(f"📌 MQ136: {mq136_v:>4.2f}V (报警: {mq136_alarm})")
    print(f"📌 MQ7:   {mq7_v:>4.2f}V (报警: {mq7_alarm})")
    print("="*35 + "\n")
